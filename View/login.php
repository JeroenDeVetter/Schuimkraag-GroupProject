...
<div id="form">
    <div class="container">
        <div class="col-lg-6">
            ...
            ?>
            <div class="alert alert-succes"><?php echo "TEST" . $succes ?></div>
            ;
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in" id="signup">
                        ...
                        <form action="" method="post" id="signup" novalidate>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firstName" class="form-control" id="first_name"
                                               required data-validation-required-message="Voornaam." autocomplete="off">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="btw" class="form-control" id="vat_nr"
                                               autocomplete="off">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="emailRegister" class="form-control" id="email" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="phoneNum" class="form-control" id="phone" required
                            ...
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <input type="street" name="streedName" class="form-control" id="street" required
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="street" name="houseNum" class="form-control" id="streetnumber"
                                               required
                                               data-validation-required-message="Gelieve hier Uw straatnaam en huisnummer in te geven."
                                               autocomplete="off">
                                        <p class="help-block text-danger"></p>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-3">
                                    ...
                                    <input type="PC" name="postcode" class="form-control" id="postcode" required
                                ...
                                <div class="form-group col-sm-9">
                                    <select name="gemeente" class="form-control" maxlength="4" id="target" {#
                                            style="background-color:rgba(90, 90, 90, 0.5);border-width: 1.25px;opacity:75%;border-color: white;color: whitesmoke;overflow-x: hidden;margin-top: 25px;height: 43px;"
                                            #}>
                                    </select>
                            ...
                            <div class="row">
                                <div class=" col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="registerPass" class="form-control" id="password"
                                               required
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password_control" required
                    ...
                    <div class="tab-pane fade active in" id="login">
                        ...
                        <form action="" method="post" id="login" novalidate>
                            <div class="form-group">
                                <label> Emailadres <span class="req">*</span> </label>
                                <input type="email" name="emailLog" class="form-control" id="email_login" required
                            ...
                            <div class="form-group">
                                <label> Paswoord <span class="req">*</span> </label>
                                <input type="password" name="passLog" class="form-control" id="password_login" required
