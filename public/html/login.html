...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="street" class="form-control" id="streetnumber" required data-validation-required-message="Gelieve hier Uw straatnaam en huisnummer in te geven." autocomplete="off">
                                            <p class="help-block text-danger"></p>
                                        </div>
                                    </div>
                                </div>
    ...
    <footer class="flex-rw ">
        ...
        <section class="footer-bottom-section flex-rw ">
            ...
            <div class="footer-bottom-wrapper ">
                <a href="/terms-of-use.html " class="generic-anchor " rel="nofollow ">Terms</a> | <a href="/privacy-policy.html " class="generic-anchor " rel="nofollow ">Privacy Beleid</a>
            </div>
        </section>
    </footer>
